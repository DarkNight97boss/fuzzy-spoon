...
Unirse al VIP premium
<br>
<span class="date">Suscripción mensual VIP Premium.</span>
</div>
<style>a{color:#069;}</style><br>
<a>Las ventajas únicas del club VIP:</a><br><br>

<li class="payment__steps__title">{Como Membrecia Premium.}</li>
<li class="payment__steps__title">PLACAS VIP, RARES. EFECTOS. Comandos especiales. y mas</li>
<a class="button raised green" href="<?php print URL; ?>/proceedWithPayment/VIP/2" style="
    float: right;
    width: auto;
    padding: 9px;
    margin-top: -46px;
    margin-bottom: 12px;
">
<div class="center" style="line-height: 32px;" fit="">Comprar por <?php print Settings('Prix_VIP_2'); ?> Diamantes</div>
