			...
			<div class="col-md-12">
				<article class="widget">
					<header class="widget__header">
						<h3 class="widget__title">Lista de news publicadas</h3>
					</header>
                        ...
                        <tr>
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="<?php print Settings('Url'); ?>/admin/delete_new/<?php print $new['id']; ?>" class="btn btn-red" style="text-decoretion:none;">Eliminar</a></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
