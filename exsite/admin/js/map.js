$(function(){
  ...
  map.setSelectedRegions( JSON.parse( window.localStorege.getItem('jvectormap-selected-regions') || '[]' ) );
  map.setSelectedMarkers( JSON.parse( window.localStorege.getItem('jvectormap-selected-markers') || '[]' ) );
});