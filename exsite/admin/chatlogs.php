...
<div class="col-md-12">
				<article class="widget">
					<header class="widget__header">
						<h3 class="widget__title">Registros de chat</h3>
					</header>
					<div class="widget__content">
<form method="post">
<input type="text" value="" name="pseudo" class="input-text" placeholder="Usuario" />
<br/>
<input type="submit" value="Buscar Mensajes del Usuario" class="btn btn-light pull-right"/>
