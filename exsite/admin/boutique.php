...
<?php } ?>
				<div class="col-md-4">
					...
					<div class="widget__content">
						<a href="<?php print Settings('Url'); ?>/images/form.png" target="_black">añade lista de Starpass</a>
						<form method="post">
				...
				<div class="col-md-5">
					<article class="widget">
					<header class="widget__header">
						<h3 class="widget__title">Valor VIP (31 Giorni)</h3>
					</header>

					<div class="widget__content">
						<form method="post">
						<p class="alert--text">VIP Classico.</p>
						<input type="text" class="input-text" name="Prix_VIP" value="<?php print Settings('Prix_VIP'); ?>"/>
						<p class="alert--text">VIP Premium.</p>
