	...
	<article class="widget" class="close" data-dismiss="alert" aria-hidden="true">
			...
			<div class="col-md-7">
				<article class="widget">
					<header class="widget__header">
						<h3 class="widget__title">Lista De Rangos</h3>
					</header>
				...
				<td><button class="btn btn-green" name="rankid" value="<?php print $rank['id']; ?>" type="submit">Modificar</button></form><form method="post"><button class="btn btn-red" style="margin-top:-80px;margin-left:100px;" name="suppid" value="<?php print $rank['id']; ?>" type="submit" <?php if ($rank['id'] <= 7) { ?>disabled<?php } ?>>Eliminar</button></form></td>
				</tr>
				<?php } ?>
				</tbody>
						</table>
				...
				<article class="widget">
					<header class="widget__header">
						<h3 class="widget__title">Administración de seguridad</h3>
					</header>
				...
				<td><div class="dropdown">
					<form method="post">
						...
						<td><button class="btn btn-green" name="pagename" value="<?php print $hk['nom']; ?>" type="submit">Modificar</button></form></td>
						</div>
				</td>
				</tr>
				<?php } ?>
