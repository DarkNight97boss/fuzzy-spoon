...
ob_start();
	...
	require_once 'hk/inc/databasegiovanni.php';
	$user->logged('no');
?>
<!DOCTYPE html>
<html lang="no">
...
<link rel="stylesheet" href="giovanni/alert.css" />
...
<?php if(MAINTENANCE == 1) echo '<div id="alert" style="z-index: 999;"><a class="alert">La modalità manutenzione è attiva!</a></div>';
else echo '<div id="alertgio" style="z-index: 999;"><a class="alertgio">La manutenzione è disattivata</a></div>';?>
	<header id="page-header" style="top:70px;">
		<div class="container">
			<h1><a href="index"><img src="hubixlogo.png" alt="Hubix Hotel" /></a></h1>
			<form action="<?php echo PATH; ?>/submitmanutenzione.php" method="post" class="login"> 
...
<div class="row">
	<div id="register-slogan">
		<h1>Manutenzione</h1>
		<h2>Questo accesso è consentito solo per gli amministratori!</h2>
	</div>
